...
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) VALUES (dog, '2025-06-10 08:00:00', 30, 'Parklands', 'open') WHERE dog IN (SELECT dog_id FROM Dogs WHERE )