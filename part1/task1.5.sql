...
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) VALUES (dog, '2025-06-10 09:30:00', 30, 'Parklands', 'open') WHERE dog IN (SELECT dog_id FROM Dogs WHERE name = 'Bella');
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) VALUES (dog, '2025-06-10 09:00:00', 30, 'Parklands', 'open') WHERE dog IN (SELECT dog_id FROM Dogs WHERE name = 'Sheep');
...
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) VALUES (dog, '2025-06-10 11:00:00', 30, 'Parklands', 'open') WHERE dog IN (SELECT dog_id FROM Dogs WHERE name = 'Duck');