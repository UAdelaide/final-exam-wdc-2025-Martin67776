...
INSERT INTO Dogs (owner_id, name, size) VALUES (owner, 'Bella', 'small') WHERE owner IN (SELECT user_id FROM Users WHERE username = 'alice123');
INSERT INTO Dogs (owner_id, name, size) VALUES (owner, 'Sheep', 'medium') WHERE owner IN (SELECT user_id FROM Users WHERE username = 'alice123');
...
INSERT INTO Dogs (owner_id, name, size) VALUES (owner, 'Duck', 'medium') WHERE owner IN (SELECT user_id FROM Users WHERE username = 'alice123');